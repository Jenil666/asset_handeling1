            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Opacity(
                    opacity: 0.7,
                      child: Image.asset("assets/images/backgroundp3.jpg",fit: BoxFit.fill,)),
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Transform.rotate(
                    angle: pi/2,
                    child: Text("LIFE IS REALLY SIMPLE, BUT WE INSISTY\nON MAKING IT COMPLICATED",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)),
              ),
              Padding(
                padding: EdgeInsets.only(left: 50,top: 600),
                child: Transform.rotate(
                    angle: pi/2,
                    child: Text("SCROLL",style: TextStyle(color: Colors.white),)),
              ),
              Padding(
